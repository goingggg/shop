                        ...
                        <form:form id="inputForm" action="/user/save" method="post" modelAttribute="tbUser" class="form-horizontal">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:password class="form-control required" path="password" placeholder="请输入登录密码" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input class="form-control required" path="username" placeholder="请输入用户的姓名" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input class="form-control required mobile" path="phone" placeholder="请输入用户的手机号" />
                                    </div>
                                </div>
                            </div>
